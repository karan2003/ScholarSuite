...
// Extend the Class type to include the grade and supervisor relations.
// Note: supervisor is optional as per the schema.
...
const ClassListPage = async ({
  ...
  // Include both supervisor and grade relations
